...
export const CSV_TEMPLATE = [
  ...
  "# Columnas opcionales:   notas, ticket (agrupa varias filas en una misma transacción)",
  "# fecha acepta YYYY-MM-DD o YYYY-MM-DD HH:MM",
  "# tipo = venta | compra",
  "# Borra estas líneas (las que empiezan con #) y llena con tus datos:",
